...
const Project = {
  ...
  create: async (data) => {
    ...
    const sql = 'INSERT INTO projects (buyer_id, title, description, domain, trl_level, expected_outcome, risk_categories, budget_min, budget_max, deadline, status) VALUES ($1, $2, $3, $4, $5, $6, $7::text[], $8, $9, $10, COALESCE($11, \'draft\')) RETURNING *';
  ...
  createProposal: async (projectId, expertId, data) => {
    ...
    const sql = 'INSERT INTO proposals (project_id, expert_id, quote_amount, duration_days, message, status) VALUES ($1, $2, $3, $4, $5, \'pending\') RETURNING *';
